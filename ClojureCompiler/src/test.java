...
public class test implements testConstants {
  ...
  static final public repeatNode repeat() throws ParseException {
  Token t1, t2;
  valueNode s1, s2;
  ...
  static final public loopNode loop() throws ParseException {
  ...
  static final public conditionNode cond() throws ParseException {
  conditionNode c = new conditionNode();
  Token t1, t2, t3;
  valueNode s1, s2, s3;
    jj_consume_token(OPEN);
    t1 = jj_consume_token(COMPAREOP);
    ...
    if (jj_2_11(2)) {
      ...
      t2 = jj_consume_token(VAR);
                    s2 = new varNode(t2.image); c.addChild(s2);
    } else if (jj_2_13(2)) {
      t2 = jj_consume_token(STR);
    ...
    if (jj_2_15(2)) {
      t3 = jj_consume_token(INT);
                    s3 = new intNode(t3.image); c.addChild(s3);
    } else if (jj_2_16(2)) {
      t3 = jj_consume_token(VAR);
                    s3 = new varNode(t3.image); c.addChild(s3);
    } else if (jj_2_17(2)) {
      t3 = jj_consume_token(STR);
                    s3 = new stringNode(t3.image); c.addChild(s3);
    } else if (jj_2_18(2)) {
      t3 = jj_consume_token(BOOL);
                     s3 = new boolNode(t3.image); c.addChild(s3);
    } else {
      jj_consume_token(-1);
      throw new ParseException();
    }
  ...
  static final public printNode print() throws ParseException {
  ...
  static final public assignNode assign() throws ParseException {
  assignNode ass = new assignNode();
  Token t1, t2;
  valueNode s1, s2;
    jj_consume_token(DEF);
    t1 = jj_consume_token(VAR);
                  s1 = new stringNode(t1.image); ass.addChild(s1);
    if (jj_2_28(2)) {
      t2 = jj_consume_token(INT);
                           s2 = new intNode(t2.image); ass.addChild(s2);
    } else if (jj_2_29(2)) {
      t2 = jj_consume_token(STR);
                           s2 = new stringNode(t2.image); ass.addChild(s2);
    } else if (jj_2_30(2)) {
      t2 = jj_consume_token(BOOL);
                            s2 = new boolNode(t2.image); ass.addChild(s2);
    } else if (jj_2_31(2)) {
      t2 = jj_consume_token(READ);
                                   s2 = new stringNode(t2.image); ass.addChild(s2);
    } else {
      jj_consume_token(-1);
      throw new ParseException();
  ...
  blockNode b, defaultBlock;
    ...
    t1 = jj_consume_token(VAR);
                  s1 = new varNode(t1.image);
    label_4:
    while (true) {
      if (jj_2_32(2)) {
        t2 = jj_consume_token(INT);
                      s2 = new intNode(t2.image);
      } else if (jj_2_33(2)) {
        t2 = jj_consume_token(STR);
                      s2 = new stringNode(t2.image);
      } else if (jj_2_34(2)) {
        t2 = jj_consume_token(BOOL);
                       s2 = new boolNode(t2.image);
      } else {
        jj_consume_token(-1);
        throw new ParseException();
      }
  ...
  static private boolean jj_3R_8() {
    if (jj_scan_token(MATHOP)) return true;
    if (jj_scan_token(VAR)) return true;
    return false;
  }
